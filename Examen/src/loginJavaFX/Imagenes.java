    ...
    public void start(Stage stage) throws FileNotFoundException {
        ...
        btnIngreso.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    Ingresos ingr = new Ingresos(cuenta);
                    ingr.start(stage);
                } catch (Exception ex) {
        ...
        btnRetirada.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    Retirar ret = new Retirar(cuenta);
                    ret.start(stage);
                    stage.show();
                } catch (Exception ex) {
                    //Logger.getLogger(Imagenes.class.getName()).log(Level.SEVERE, null, ex);
        ...
        btnTransferencia.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    Transferencia tran = new Transferencia(cuenta);
                    tran.start(stage);
                } catch (Exception ex) {
                    //Logger.getLogger(Imagenes.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        btnEstadistica.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                try {
                    Estadistica est = new Estadistica(cuenta);
                    est.start(stage);
                } catch (Exception ex) {
                    //Logger.getLogger(Imagenes.class.getName()).log(Level.SEVERE, null, ex);
                }
